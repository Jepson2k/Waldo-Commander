    ...
    if _mcp is None:
        ...
        _mcp = FastMCP(
            ...
            instructions=(
                ...
                "Programs are plain Python scripts run in a subprocess — they "
                "drive the robot through the backend client library, not these "
                "MCP tools. Don't guess that API: call programs.list_library "
                "and open a worked example (programs.open) to learn the motion "
                "calls before authoring your first program.\n\n"
